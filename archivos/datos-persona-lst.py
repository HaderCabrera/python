...
def menuModificar(lstPersonal, id):
    while True:
        try:
            print("\n" * 30)
            print("*** MODIFICAR PERSONA ***".center(40))
            print("MENU".center(40))
            print("1. Nombre")
            print("2. Edad")
            print("3. Sexo")
...
# *** PROGRAMA PRINCIPAL ***
rutaFile = "/home/skylab-102/hader_cabrera/archivos/datpersonal.json"
lstPersonal = []
...
while True:
    ...
    if op == 1:
        ...
        # Modificar
        id = input("Indique el ID de la persona que quiere modificar: ")
        opModificar = menuModificar(lstPersonal, id)
        while True:
            if opModificar == 1:
                agregarPersonal(lstPersonal, rutaFile)
            elif opModificar == 2:
